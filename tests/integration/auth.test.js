...
describe('Auth routes', () => {
  ...
  describe('POST /v1/auth/logout', () => {
    test('should return 204 if refresh token is valid', async () => {
      ...
      await tokenService.saveToken({ token: refreshToken, userId: userOne._id, expires, type: tokenTypes.REFRESH });
  ...
  describe('POST /v1/auth/verify-email', () => {
    test('should return 204 and verify the email', async () => {
      ...
      await tokenService.saveToken({ token: verifyEmailToken, userId: userOne._id, expires, type: tokenTypes.VERIFY_EMAIL });
