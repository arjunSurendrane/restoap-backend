const SubscriptionPaymentSuccess = (name, planname, amount, date, interval) => {
    return `<!DOCTYPE html>
                                ...
                                <table border="0" width="600" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr bgcolor="ffffff">
                                        <td align="center"><img style="display: block;" class="main-image" width="600"
                                                height="auto"
                                                src="https://restoap-assets.s3.amazonaws.com/subscription-payment.png" />
                                        </td>
                                    </tr>
                                    <tr bgcolor="ffffff">
                                        <td height="20"></td>
                                                ...
                                                <tr bgcolor="ffffff">
                                                    <td>
                                                        <table width="528" border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h1 style="color: #212B36;text-align: left;">Thank you
                                                                        for your <span
                                                                            style="color:#BB3138; ">Payment</span> </h1>
                                                                    <p
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Thank you for your recent subscription payment to
                                                                        Restoap! We're excited to have you on board.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p>${planname} account on Restoap - INR Rs.${amount} per ${interval}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
...
module.exports = SubscriptionPaymentSuccess;
