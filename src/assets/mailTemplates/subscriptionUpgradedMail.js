const SubscriptionUpgrade = (name, planname, amount, interval) => {
    return `<!DOCTYPE html>
                                ...
                                <table border="0" width="600" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr bgcolor="ffffff">
                                        <td align="center"><img style="display: block;" class="main-image" width="600"
                                                height="auto"
                                                src="https://restoap-assets.s3.amazonaws.com/subcription-upgrade.png" />
                                        </td>
                                    </tr>
                                    <tr bgcolor="ffffff">
                                        <td height="20"></td>
                                                                ...
                                                                <td>
                                                                    <h1 style="color: #212B36;text-align: left;">Your
                                                                        subscription has <span
                                                                            style="color:#BB3138; ">Upgraded</span> </h1>
                                                                    <p
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We hope this email finds you well. We're excited to
                                                                        inform you that your subscription with Restoap has
...
module.exports = SubscriptionUpgrade;
