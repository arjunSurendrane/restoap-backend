const SubscriptionExpired = (name, planname, date) => {
    return `<!DOCTYPE html>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <table border="0" width="600" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr bgcolor="ffffff">
                                        <td align="center"><img style="display: block;" class="main-image" width="600"
                                                height="auto"
                                                src="https://restoap-assets.s3.amazonaws.com/subscription-caneled.png" />
                                        </td>
                                    </tr>
                                    <tr bgcolor="ffffff">
                                        <td height="20"></td>
                                                ...
                                                <tr bgcolor="ffffff">
                                                    <td>
                                                        <table width="528" border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h1 style="color: #212B36;text-align: left;">Your subscription has  <span
                                                                            style="color:#BB3138; ">Cancelled</span> </h1>
                                                                    <p
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We're sorry to see you go. We hope you enjoyed using our service. Remember, you can come back anytime you like, clicking the 'Subscribe Now' button to renew your subscription now and we can keep going!
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            <tr>
                                                                <td>
                                                                    <p
                                                                        style="color:#BB3138 ; line-height:14px; font-size:18px ;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p>${planname} account on Restoap </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <p>Cancellation date : ${date}</p>
                                                                </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p style="color:#212b36 ; line-height:24px; font-size:18px ;">
                                                Regards,
                                            </p>
                                            <p>RESTOAP Team</p>
                                        </td>
            ...
            <tr bgcolor="ffffff">
                <td align="center"><img style="display: block;" class="main-image" width="600" height="auto"
                        src='https://restoap-assets.s3.amazonaws.com/bottomBg.png' />
                </td>
            </tr>
        </table>
        </td>
...
module.exports = SubscriptionExpired;
