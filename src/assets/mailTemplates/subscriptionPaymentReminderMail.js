const SubscriptionPaymentReminder = (name, date, invoiceUrl, dueDate) => {
    return `<!DOCTYPE html>
                                                ...
                                                <tr bgcolor="ffffff">
                                                    <td>
                                                        <table width="528" border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h1 style="color: #212B36;text-align: left;">Reminder of
                                                                        <span style="color:#BB3138; ">Upcoming
                                                                            Payment</span>
                                                                    </h1>
                                                                    <p
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        This is a friendly reminder that your Restoap subscription payment is due on ${dueDate}. To ensure uninterrupted access to our services, please make your payment on or before the due date. 
                                                                </td>
                                                                </tr>
                                                                <tr>
                                                                <td>
...
module.exports = SubscriptionPaymentReminder;
